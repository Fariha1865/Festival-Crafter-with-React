            ...
            <h1 className="text-4xl font-bold text-center mb-16">Upcoming Events arranged by us</h1>
                ...
                >
                    <div className='flex justify-end'>
                        <div className="card w-[700px] bg-base-100 shadow-xl shadow-gray-400 flex flex-row">
                            <img src="https://i.ibb.co/jwWKLCm/food.jpg" alt="Shoes" className='w-1/3 rounded-t-mg' />
                ...
                >
                    <div className='flex'>
                        <div className="card w-[700px] bg-base-100 shadow-xl shadow-gray-400 flex flex-row mt-10">
                            <img src="https://i.ibb.co/QvxLwhw/school-winter.jpg" alt="Shoes" className='w-1/3 rounded-t-mg' />
                            <div className="card-body">
                ...
                >
                    <div className='flex justify-end'>
                        <div className="card w-[700px] bg-base-100 shadow-xl shadow-gray-400 flex flex-row mt-10">
                            <img src="https://i.ibb.co/F51hqSd/Pitha-1.jpg" alt="Shoes" className='w-1/3 rounded-t-mg' />
                            <div className="card-body">
